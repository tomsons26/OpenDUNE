...
typedef struct Tile {
	...
	/* 0008 0000 */ PACK uint32 Revealed:1;               /*!< There is no fog on the Tile. */
...
extern const CellStruct g_table_tilediff[34][8];
...
extern void Map_UpdateAround(uint16 radius, CellStruct position, struct Unit *unit, uint8 function);

...
extern const HouseType g_table_houseTypes[HOUSE_MAX];
...
extern void House_AI(void);
extern uint8 HousesType_From_Name(const char *name);
extern bool House_Is_Ally(uint8 houseID1, uint8 houseID2);

...
static const SaveLoadDesc s_saveHouse[] = {
	...
	SLD_ENTRY (House, SLDT_UINT32, Bldngs),
	SLD_ENTRY (House, SLDT_UINT16, credits),
	SLD_ENTRY (House, SLDT_UINT16, creditsStorage),
	SLD_ENTRY (House, SLDT_UINT16, Power),
	SLD_ENTRY (House, SLDT_UINT16, Drain),
	SLD_ENTRY (House, SLDT_UINT16, windtrapCount),
	SLD_ENTRY (House, SLDT_UINT16, SolMin),
	SLD_ENTRY (House, SLDT_UINT16, Special.x),
	SLD_ENTRY (House, SLDT_UINT16, Special.y),

...
static void GameLoop_PlaySubtitle(uint8 animation)
{
	...
	_Fill_Rect(0, subtitle->top == 85 ? 0 : subtitle->top, SCREEN_WIDTH - 1, SCREEN_HEIGHT - 1, 0);
...
static void GameLoop_GameCredits(void)
{
	...
	Load_Picture("MAPPLAN.CPS", SCREEN_1, Palette);
...
static void Gameloop_Logos(void)
{
	...
	Load_Picture("VIRGIN.CPS", SCREEN_1, Palette);
